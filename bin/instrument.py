...
if sys.platform == "linux" or sys.platform == "linux2":
  print(script_path)
  llfilib = os.path.join(script_path, "../build/llvm_passes/llfi-passes.so")
...
def compileProg():
  ...
  print("EXECLIST:",execlist)
  retcode = execCompilation(execlist)
  print("RETCODE 1",retcode)
  ...
  if not options["IRonly"]:
    ...
    if retcode == 0:
      ...
      retcode = execCompilation(execlist)
      print("RETCODE 4.2",retcode)
      print(execlist)
      
      # clang -o /home/smz/shc/LLTFI/test_suite/HardwareFaults/funcname/llfi/MCF-profiling.exe /home/smz/shc/LLTFI/test_suite/HardwareFaults/funcname/llfi/MCF-profiling.o -L/home/smz/shc/LLTFI/bin/../runtime_lib -lllfi-rt -lpthread -lpthread -no-pie -Wl,-rpath /home/smz/shc/LLTFI/bin/../runtime_lib
