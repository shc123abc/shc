...
class TestMessageSetContainer final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::proto2_wireformat_unittest::TestMessageSet* release_message_set();
...
class TestMessageSetExtension1 final :
 ...
 private:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_test_aliasing();
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::proto2_wireformat_unittest::TestMessageSet* release_recursive();
...
inline std::string* TestMessageSetExtension1::release_test_aliasing() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return test_aliasing_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
