...
class TestAllTypes final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* release_optional_nested_message();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::proto2_nofieldpresence_unittest::ForeignMessage* release_optional_foreign_message();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::protobuf_unittest::TestAllTypes* release_optional_proto2_message();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* release_optional_lazy_message();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* release_oneof_nested_message();
...
class TestProto2Required final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::protobuf_unittest::TestRequired* release_proto2();
