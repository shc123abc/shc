...
class TestConflictingSymbolNames final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_length__();
 ...
 private:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_some_cord();
 ...
 private:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_some_string_piece();
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_release_length();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_target();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::protobuf_unittest::TestConflictingSymbolNames_DO* release_do__();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::protobuf_unittest::TestConflictingSymbolNames_DO* release_release_do();
