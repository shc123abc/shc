...
class TestOptimizedForSize final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::protobuf_unittest::ForeignMessage* release_msg();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_string_field();
...
class TestOptionalOptimizedForSize final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::protobuf_unittest::TestRequiredOptimizedForSize* release_o();
